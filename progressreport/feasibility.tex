...
The project is designed to be applicable on relatively low-end devices. The hardware requirement for Llama-2 7B is approximately 16GB of VRAM, which is widely available in consumer-grade GPUs such as the NVIDIA RTX 3060 or 4060, as well as the Google Colab free tier (T4 GPU). 
