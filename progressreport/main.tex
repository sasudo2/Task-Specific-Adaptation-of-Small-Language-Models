...
% \usepackage{bookmark} % Temporarily commented - causes BKM@entry error
...
\newacronym{bleu}{BLEU}{Bilingual Evaluation Understanding}
...
\include{methodology}
\include{implemetation}
\include{Final_outcome}
\include{schedule}
\include{remaining_tasks}
