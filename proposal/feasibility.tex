...
\begin{normaltext}
    This project is primarily targeted at fine-tuning large language models for Python code generation using Parameter Efficient Fine Tuning (PEFT) with QLoRA. The feasibility of this project can be analyzed from several perspectives:
    ...
    The project uses freely available models along with open-source datasets, and the hardware constraints are low enough to utilize consumer-grade GPUs or free cloud based services like Google Colab.
