...
Figure~\ref{figflowchart} shows the flowchart of the fine-tuning procedure.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\linewidth]{flowdiagram.png} % Uncomment when you add the figure
    \caption{Final Model Block Diagram}
    \label{figflowdiagram}
\end{figure}
